...
public class DownloadedAdapter extends ArrayAdapter<DownloadTask> {
    ...
    public DownloadedAdapter (Context context, int textViewResourceId, List<DownloadTask> taskList) {
...
//        }
        ...
        switch (mTaskList.get(position).getDownloadState()) {
            ...
            case FINISHED:
                ...
                holder.mStateImageView.setImageResource(R.drawable.comment_like_pop_notip_selected);
                break;
            case INITIALIZE:
                holder.mProgressBar.setIndeterminate(false);
