...
public class Eqpt_InfoDao {
	...
	public boolean addEqptInfo(EqptInfoBean.EqptInfo eqptInfo) {
		boolean flag = false;
	...
	public List<EqptInfoBean.EqptInfo> getAllEqptInfoList() {
	...
	public EqptInfoBean.EqptInfo getEqptInfo(String eqptName) {
	...
	public List<EqptInfoBean.EqptInfo> getLikeEqptInfoList(String keywords) {
		List<EqptInfoBean.EqptInfo> list = new ArrayList<EqptInfo>();
		EqptInfoBean bean = new EqptInfoBean();
		EqptInfo eqptInfo;
