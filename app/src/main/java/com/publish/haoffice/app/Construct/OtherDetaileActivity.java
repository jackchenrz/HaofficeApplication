 ...
 */
public class OtherDetaileActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    TextView tv_title;
    public static OtherDetaileActivity instance = null;

    private OtherDetaileFragment otherDetaileFragment;
    ...
    public void initView (View view) {
        ...
        rb_construct.setText("点外项目详情");
        tv_title.setText("详情页");
        ll_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick (View v) {
                finishActivity(OtherDetaileActivity.this);
            }
        });

        Intent intent = getIntent();
        OtherJobID = intent.getStringExtra("OtherJobID");
    }
    ...
    protected void select (int i) {
        ...
        bundle.putString("OtherJobID",OtherJobID);
        ...
        switch (i) {
            case 0:
                ...
                if (otherDetaileFragment == null) {
                    otherDetaileFragment = new OtherDetaileFragment();
                    otherDetaileFragment.setArguments(bundle);
                    ft1.add(R.id.fragment_container1, otherDetaileFragment,"DETAIL");
                } else {
                    ft1.show(otherDetaileFragment);
                }
    ...
    private void hidtFragment (FragmentTransaction fragmentTransaction) {
        if (otherDetaileFragment != null) {
            fragmentTransaction.hide(otherDetaileFragment);
        }
        if (comWorkStateFragment != null) {
