 ...
 */
public class ConDetaileActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    TextView tv_title;
    public static ConDetaileActivity instance = null;

    private ConDetaileFragment conDetaileFragment;
    private ConWorkCardFragment conWorkCardFragment;
    ...
    public void initView (View view) {
        ...
        ll_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v) {
                finishActivity(ConDetaileActivity.this);
            }
        });

        Intent intent = getIntent();
        constructionID = intent.getStringExtra("ConstructionID");
    }
    ...
    protected void select (int i) {
        ...
        bundle.putString("ConstructionID",constructionID);
        ...
        switch (i) {
            case 0:
                ...
                if (conDetaileFragment == null) {
                    conDetaileFragment = new ConDetaileFragment();
                    conDetaileFragment.setArguments(bundle);
                    ft1.add(R.id.fragment_container1, conDetaileFragment,"DETAIL");
                } else {
                    ft1.show(conDetaileFragment);
                }
            ...
            case 1:
                ...
                rb_other.setTextColor(this.getResources().getColor(R.color.darkblack));
                if (conWorkCardFragment == null) {
                    conWorkCardFragment = new ConWorkCardFragment();
                    conWorkCardFragment.setArguments(bundle);
                    ft1.add(R.id.fragment_container1, conWorkCardFragment);
                } else {
                    ft1.show(conWorkCardFragment);
                }
    ...
    private void hidtFragment (FragmentTransaction fragmentTransaction) {
        if (conDetaileFragment != null) {
            fragmentTransaction.hide(conDetaileFragment);
        }
        if (conWorkCardFragment != null) {
            fragmentTransaction.hide(conWorkCardFragment);
        }
        if (comWorkStateFragment != null) {
...
//                }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(disX > disY && disX > 5){
                    ...
                    }else if(rb_construct.isChecked()){
                        if(downX - moveX > 30){
                            select(1);
                            break;
                        }else{
